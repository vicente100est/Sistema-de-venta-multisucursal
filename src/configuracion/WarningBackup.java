...
public class WarningBackup extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/configuracion/label-backup.png"))); // NOI18N
        ...
        btnAceptar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/configuracion/btn-crear.png"))); // NOI18N
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        if (this.txtNombre.getText().isEmpty()) {
            ...
            this.lblError.setText("¡Debe ingresar un nombre para el respaldo!");
        } else {
            continuar = true;
            this.dispose();
        }
