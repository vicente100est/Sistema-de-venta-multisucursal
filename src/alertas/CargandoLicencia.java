 ...
 * @author RojeruSan
 */
public class CargandoLicencia extends javax.swing.JDialog {

    /**
     * Creates new form Cargando
     */
    public CargandoLicencia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Logger.getLogger(CargandoLicencia.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Verificando Licencia...");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CargandoLicencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CargandoLicencia dialog = new CargandoLicencia(new javax.swing.JFrame(), true);
