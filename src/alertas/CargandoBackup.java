...
import configuracion.cargarBackup;
...
public class CargandoBackup extends javax.swing.JDialog {
     ...
     */
    public CargandoBackup(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        msj.setText("Generando Respaldo...");
    ...
    private void progresoStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_progresoStateChanged
        if (progreso.getValue() == 30) {
            this.msj.setText("Generando Respaldo...");
        }
