...
public class CargandoRestore extends javax.swing.JDialog {
     ...
     */
    public CargandoRestore(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
       ...
       new Thread(new Runnable() {
            @Override
            public void run() {
                new Restore().restoreDB(pnlConfiguracion.existe.getAbsolutePath());
            }
        }).start();
    }
    ...
    private void initComponents() {
        ...
        msj.setText("Iniciando restauración de la base de datos...");
    ...
    private void progresoStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_progresoStateChanged
        if (progreso.getValue() == 30) {
            this.msj.setText("Descomprimiendo respaldo...");
        }
